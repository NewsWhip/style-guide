...
import { CircleDirective, XAxisDirective, YAxisDirective } from 'nw-style-guide/charts';
...
@Component({
    ...
    imports: [ChartsModule, TabsModule, CommonModule, ReactiveFormsModule, FormsModule]
})
